...
class _CreateBudgetStep3PageState extends ConsumerState<CreateBudgetStep3Page> {
  late List<DraftArea> _areas;

  @override
  void initState() {
    super.initState();
    _areas = CreateBudgetState.instance.expenseAreas.isNotEmpty
        ? CreateBudgetState.instance.expenseAreas
        : [];
  ...
  // Block subcategories already used across both income and expense areas
  Set<int> get _usedSubcategoryIds {
    final incomeIds = CreateBudgetState.instance.incomeAreas
        .expand((a) => a.subcategories)
        .map((s) => s.id);
    final expenseIds =
        _areas.expand((a) => a.subcategories).map((s) => s.id);
  ...
  void _next() {
    ...
    CreateBudgetState.instance.expenseAreas = _areas;
    context.push('/budgets/create/step4');
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Create areas and add subcategories with the spending limit for each.',
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                'Add Expense Area',
                                style:
                                    AppTextStyles.body(t.error).copyWith(
                                  fontSize: 14,
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Add Subcategory',
                        style: AppTextStyles.bodySm(t.error).copyWith(
            ...
            children: [
              ...
              IntrinsicWidth(
                child: TextField(
                  ...
                  style: AppTextStyles.mono(t.error, fontSize: 14)
                      .copyWith(fontWeight: FontWeight.w700),
